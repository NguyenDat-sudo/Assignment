...
void MadTroll(int &HP, int&HPmax, int &level, int &levelO, int &name, int &event, int &remedy, int &maidenkiss, int &phoenixdown, int &rescue, int &tiny, int &frog)  {       
...
void adventureToKoopa(string file_input, int & HP, int & level, int & remedy, int & maidenkiss, int & phoenixdown, int & rescue) {
    ...
    while (tc1 >> event) {
        ...
        if (event==1) MadTroll(HP,HPmax,level,levelO,name,event,remedy,maidenkiss,phoenixdown,rescue,tiny,frog);
        if (event==2) MadTroll(HP,HPmax,level,levelO,name,event,remedy,maidenkiss,phoenixdown,rescue,tiny,frog);
        if (event==3) MadTroll(HP,HPmax,level,levelO,name,event,remedy,maidenkiss,phoenixdown,rescue,tiny,frog);
        if (event==4) MadTroll(HP,HPmax,level,levelO,name,event,remedy,maidenkiss,phoenixdown,rescue,tiny,frog);
        if (event==5) MadTroll(HP,HPmax,level,levelO,name,event,remedy,maidenkiss,phoenixdown,rescue,tiny,frog);
